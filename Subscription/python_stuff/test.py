...
for key in word_freq:
    for word in complex_words:
        if key == word and word_freq[key]>9:
...
df=pd.DataFrame(list_of_freq,index=list_of_keys,columns=['wf'])
df=df.sort_values(by='wf')
print(df)

#print(word_freq_cleaned)
